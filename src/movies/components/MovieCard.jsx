...
const urlImage = import.meta.env.VITE_REACT_API_IMAGES;
...
export const MovieCard = ({
    ...
    const releaseYear = release_date ? new Date(release_date).getFullYear() : 'Fecha no disponible';
        ...
        <>
            <section className="movie-card">
                ...
                <div className="infotop">
                        <img className="movie-img" src={`${urlImage}/${poster_path}`} alt="" onClick={goToMovie} />
